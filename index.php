<?php include("db_connect_Login.php"); 
include('footerForAll.php'); 
session_start(); $_SESSION["loggedIn"] =0; ?>
...
if($_SERVER["REQUEST_METHOD"] == "POST"){
	...
	$sql = "SELECT userName FROM login_info WHERE username='$username' AND pass='$pass' ";
...
<div id = "head">
<img src="http://localhost/visitor/c3.jpeg" alt="omc" width="388" height="90">
